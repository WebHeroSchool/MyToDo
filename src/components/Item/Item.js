...
const Item = ({value , done , id, checkboxChange, onClickDelete}) => (<>
...
<svg onClick={() => onClickDelete(id)} className={styles.trash} viewBox="0 0 716.803 716.803" xmlns="http://www.w3.org/2000/svg">
