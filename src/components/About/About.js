...
class About extends React.Component {
  ...
  render(){
    const {isLoading, repoList ,userInfo, Erro, ErrMessage} = this.state;
      ...
      <div className={styles.wrapper}>
        {Erro ? 
          <div className={styles.error}>
            ...
            <span className={styles.error_text}>{ErrMessage.message}</span>
            <span className={styles.error_num}>{ErrMessage.status}</span>
          </div> 
          : <>
